...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-dark/30 backdrop-blur-[10px] p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
